...
function generateTable() {
    ...
    const plazoSelected = document.getElementById('plazoSelect').value; // Obtener el valor del desplegable
    ...
    lines.forEach((line, index) => {
        ...
        const cells = parseLine(line, plazoSelected); // Pasar el valor del desplegable
...
function parseLine(line, plazo) { // Añadir parámetro plazo
    ...
    if (compraVentaMatch) {
        ...
        // Limpiar los puntos de los valores de cantidad
        ...
        return [
            ...
            activo,                    // INSTRUMENTO
            plazo,                     // PLAZO (usar el valor del desplegable)
            precio,                    // PRECIO
            cantidad2Clean,            // CANTIDAD
            '',                        // CONTRAPARTE
            precioTransaccion,         // COMITENTE
            cantidadClean              // CARTERA PROPIA
        ];
    }
    return [];
}
